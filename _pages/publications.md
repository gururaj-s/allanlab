...
#### {{ publi.year }}
  ...
  <a href='{{ site.url }}{{ site.baseurl }}/papers/{{ publi.link.pdf }}'>{{ publi.title }}</a> {% if publi.link.slides %}\[<a href='{{ site.url }}{{ site.baseurl }}/slides/{{ publi.link.slides }}'></a>\]{% endif %} <br />
